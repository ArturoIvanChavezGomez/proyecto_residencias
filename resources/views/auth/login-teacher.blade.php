<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login.teacher') }}">
            ...
            <!-- Email Address -->
            <div>
                <x-label for="control_number" :value="__('Matrícula')" />
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <a class="underline text-sm text-gray-800 hover:text-gray-900" href="{{ route('register.teacher') }}">
